package com.skill_mentor.server.skill_mentor_server.security;
...
public class SecurityConfig {
    ...
    private static final String JWKS_URL = "https://prompt-condor-31.clerk.accounts.dev/.well-known/jwks.json";
